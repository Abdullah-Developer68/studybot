...
// Default loading spinner shown while auth state is initializing.
...
/**
 * Inner component that reads search params. It is wrapped in Suspense so
 * Next.js can prerender the auth page without blocking on the search params.
 */
